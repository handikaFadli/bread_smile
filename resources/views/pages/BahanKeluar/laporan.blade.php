    ...
    <div class="body">
        ...
        <table cellpadding="0" cellspacing="0">
            ...
            @foreach ($data as $dt)
                ...
                $tanggal = date('j', strtotime($dt->tgl_keluar));
                $bulan = $bulanIndo[date('n', strtotime($dt->tgl_keluar)) - 1];
                $tahun = date('Y', strtotime($dt->tgl_keluar));
                @endphp
                <tr>
                    <!-- agar nomer mengikuti pagination -->
                    <td>{{ $loop->iteration}}</td>
