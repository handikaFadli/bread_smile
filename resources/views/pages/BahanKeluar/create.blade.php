    ...
    <div class="intro-y col-span-12 lg:col-span-8">
        ...
        <div class="intro-y box px-10 py-5">
            <form action="{{ route('bahanKeluar.store') }}" method="POST">
                @csrf
                <div class="mt-3">
                    <label for="kd_bahan" class="form-label font-medium"> Bahan </label>
                    <select name="kd_bahan" id="satuan" data-placeholder="Silahkan pilih bahan" type="text" class="tom-select form-control w-full @error('kd_bahan') border-danger @enderror" required autofocus onchange="changeValue(this.value)" onclick="changeValue(this.value)">
                ...
                <div class="mt-6">
                    ...
                    <textarea name="ket" id="ket" type="text" class="form-control w-full shadow-md @error('ket') border-danger @enderror" placeholder="Masukkan Keterangan" minlength="3">{{ old('ket') }}</textarea>
                </div>
                @error('ket')
                <div class="text-danger mt-1">
                    {{ $message }}
