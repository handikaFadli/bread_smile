...
<div class="intro-y mt-10">
    ...
    <ol class="breadcrumb breadcrumb-dark mt-2 mr-auto ml-1">
        <li class="breadcrumb-item"><a href="/mobil" class="text-slate-600">{{ $menu }}</a></li>
                ...
                <tr class="intro-x">
                    ...
                    <td class="table-report__action">
                        <div class="flex justify-center items-center">
                            ...
                            <a class="flex items-center mr-2 tooltip text-success" data-theme="light" title="Edit" href="{{ route('mobil.edit', $mbl->kd_mobil) }}">
                                <i data-feather="check-square" class="w-4 h-4"></i>
                            </a>

                            <!-- trigger modal -->
                            <button class="flex items-center tooltip text-danger" data-theme="light" title="Hapus" data-tw-toggle="modal" data-tw-target="#hapus{{ $mbl->kd_mobil }}">
                                        ...
                                        <div class="modal-body p-0">
                                            <form action="{{ route('mobil.destroy', $mbl->kd_mobil) }}" method="POST">
                                                ...
                                                <div class="p-5 text-center">
                                                    ...
                                                    <div id="exampleModalLabel" class="text-2xl mt-5">Apakah yakin ingin menghapus mobil berplat <br> {{ $mbl->plat_nomor }} ?</div>
                                                    <div class="mt-3">
