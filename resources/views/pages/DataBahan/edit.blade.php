    ...
    <div class="intro-y col-span-12 lg:col-span-8">
        ...
        <div class="intro-y box px-10 py-5">
            <form class="" action="{{ route('dataBahan.update', $dataBahan->kd_bahan) }}" method="POST">
                @csrf
                @method('PUT')
                <input id="kd_bahan" name="kd_bahan" type="hidden" value="{{ $dataBahan->kd_bahan }}">
                <div class="bg-slate-100 -ml-1 w-full flex justify-center py-2 rounded-lg shadow-lg">
                    <span class="text-slate-800 font-medium uppercase text-center">Kode Bahan - {{ $dataBahan->kd_bahan }}</span>
                </div>
                ...
                <div class="mt-6">
                    ...
                    <div class="relative rounded-md">
                        ...
                        <input name="stok" id="stok" type="text" class="form-control block w-full shadow-md @error('stok') border-danger @enderror rounded-md pl-3 pr-12 sm:text-sm" value="{{ old('stok', $dataBahan->stok) }}">
