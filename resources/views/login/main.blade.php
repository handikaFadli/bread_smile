    ...
    <div class="block xl:grid grid-cols-2 gap-4">
        ...
        <div class="h-screen xl:h-auto flex py-5 xl:py-0 my-10 xl:my-0">
            <div class="my-auto mx-auto xl:ml-20 bg-white dark:bg-darkmode-600 xl:bg-transparent px-5 sm:px-8 py-8 xl:p-0 rounded-md shadow-md xl:shadow-none w-full sm:w-3/4 lg:w-2/4 xl:w-auto">
                ...
                <div class="intro-x mt-2 text-slate-400 xl:hidden text-center">Selamat datang di Web Pengelolaan Bread Smile.<br>Silahkan login menggunakan akunmu</div>
                ...
                <div class="intro-x mt-5 xl:mt-8 text-center xl:text-left">
                    ...
                    <a href="/register" class="btn btn-outline-secondary py-3 px-4 w-full xl:w-32 mt-3 xl:mt-0 align-top">Registrasi</a>
                </div>
                </form>
                <div class="intro-x mt-10 xl:mt-24 text-slate-600 dark:text-slate-500 text-center xl:text-left">
                    Kembali ke halaman utama <a class="text-primary dark:text-slate-200" href="/">disini!</a>
                </div>
            </div>
        </div>
        <!-- END: Login Form -->
